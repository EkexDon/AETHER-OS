...
/// Returns the port the browser proxy is listening on.
#[tauri::command]
pub async fn cmd_browser_proxy_port(state: State<'_, AppState>) -> Result<u16, String> {
    Ok(state.browser_proxy.port())
}
